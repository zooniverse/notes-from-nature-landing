export const collections = [
  ...
  },
  {
    ...
    description: `
      <p>The Macrofungi Collection Consortium, funded by the National Science Foundation,
         is a partnership of 35 institutions across the U.S that collectively will digitize
         about 1.5 million specimens that have been collected the past 150 years.
      </p>
      <p>Macrofungi are important to humans in many ways – many people like to eat them,
         but some species are also deadly poisonous.  Macrofungi are also key to the health
         of our forests – indeed, most forest trees could not survive if their roots did not
         form a relationship with a macrofungus (called mycorrhizae) that helps tree roots
         absorb water and minerals from the soil.  Macrofungi are also an important source
         of food for forest animals and they serve as homes for many soil insects and other
         small organisms that are also part of a healthy forest ecosystem.
       </p>
      <p>Many macrofungi are very beautiful, and are the subject of nature photographers.
         Their pigments may be used for dyeing wool or cotton, and for paper-making.
         Macrofungi are important religious symbols in some cultures.
         Recently it has been discovered that macrofungi can play a role in the
         cleanup of environmental disasters.  Through a process called “mycoremediation”
         macrofungi are able to break down or remove contaminants such as pesticides
         and fuel oils.
       </p>`,
    snippet: `The Macrofungi Collection comprises mushrooms and related fungi
      Macrofungi are often short-lived, documenting their occurrence with
      specimens is critically important for knowing which macrofungi grow where.`,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    description: `Welcome to the University of South Florida (USF) Herbarium
      ...
      specimens from as far back as the 1840s. As we depend on plants for food, medicine,
      water and air quality, soil health, paper, fabrics, cosmetics, building materials,
      and beautification, these plant specimens contain vital information that help us
      ensure the health and longevity of our species and the ecosystem. They are used
  ...
  },
  {
    ...
    institute: 'FSU',
    description: `
      Florida State University's Robert K. Godfrey Herbarium documents the
      distribution and natural variation of 2,400 species of flowering plants,
      ferns, conifers, and cycads found in northern Florida. In this region a number
      of plant groups, including pitcherplants, reach their greatest species richness
  ...
  },
  {
    ...
    institute: 'BRIT',
    description: `
      The VDB collection of the Philecology Herbarium at the Botanical Research Institute of Texas
      is composed of ca. 360,000 plant specimens and is one of the best representations of
      the flora of the southeastern United States. Each of these herbarium sheets serve as testament
      to the existence of that species in space and time. Imagine if we were able to aggregate these
      in digital space, alongside other pertinent biological and physical data. Imagine the big,
      complex questions we could ask about evolution and adaptation in our environments.
      All this begins with the simple act of transcribing a specimen label; it all begins with YOU!
    `,
    snippet: ``,
    difficulty: 'Easy',
    start_date: '1880',
