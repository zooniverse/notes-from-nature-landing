...
export const expeditions = {
  ...
  'Herbarium_Plants of Arkansas: The Delta and Crowley\'s Ridge Flora (Part III)': {
    snippet: `
  ...
  'Pinned Specimen_CalBug Leaf-cutter Bees 8': {
    snippet: `
      Megachilid (Leaf-cutter bees) bees are extraordinarily important plant
      pollinators known as leafcutter or mason bees, so named because they typically make their
      solitary nests using soil and leaves.
  ...
  'Labs_Geography: US State Spotter (Part 3) -- Secretive Sedges': {
    snippet: `
      Help connect researchers to biodiversity data by identifying the geographic area where
      each historic plant specimen was originally collected.
    `,
  ...
  'Labs_Geography: US State Spotter (Part 4) -- Reclusive Rosaceae': {
    snippet: `
      Help connect researchers to biodiversity data by identifying the geographic area where
      each historic plant specimen was originally collected.
    `,
  ...
  'Labs_Geography: US State Spotter (Part 5) -- Gone with the Grasses (IV)': {
    snippet: `
      Help connect researchers to biodiversity data by identifying the geographic area where
      each historic plant specimen was originally collected.
    `,
  ...
  'Labs_Geography: US State Spotter (Part 5) -- Gone with the Grasses (V)': {
    snippet: `
      Help connect researchers to biodiversity data by identifying the geographic area where
      each historic plant specimen was originally collected.
    `,
  ...
  'Pinned Specimen_CalBug Leaf-cutter Bees 11': {
    snippet: `
      Megachilid (Leaf-cutter bees) bees are extraordinarily important plant pollinators known as leafcutter or mason bees,
      so named because they typically make their solitary nests using soil and leaves.
    `,
  ...
  'Labs_Geography: US State Spotter -- Anomalous Asters (II)': {
    snippet: `
      Help connect researchers to biodiversity data by identifying the geographic area
      where each historic plant specimen was originally collected.
    `,
  ...
  'Pinned Specimen_CalBug Leaf-cutter Bees 12': {
    snippet: `
      Megachilid (Leaf-cutter bees) bees are extraordinarily important plant pollinators known as leafcutter or mason bees,
      so named because they typically make their solitary nests using soil and leaves.
    `,
  ...
  'Herbarium_cARexpedition: Carex sedge exploration in Arkansas': {
    snippet: `
      Many Carex species grow at the limits of their ranges in Arkansas.
      Help us explore the distribution of sedges!
    `,
  ...
  'Herbarium_Plants of Arkansas: The Delta and Crowley\’s Ridge Flora (Part V)': {
    snippet: `
      The Delta and Crowley's Ridge Flora--The Arkansas Delta Region is a vastly
      under-explored region of the Natural State in need.
    `,
